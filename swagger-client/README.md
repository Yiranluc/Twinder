...
twinder
- API version: 1.0.0
  - Build date: 2023-01-31T01:15:03.548Z[GMT]
...
------------ | ------------- | ------------- | -------------
*SwipeApi* | [**swipe**](TwinderProject/clients/SwipeApi.md#swipe) | **POST** /swipe/{leftorright}/ | 

## Documentation for Models

 - [ResponseMsg](TwinderProject/clients/ResponseMsg.md)
 - [SwipeDetails](TwinderProject/clients/SwipeDetails.md)
